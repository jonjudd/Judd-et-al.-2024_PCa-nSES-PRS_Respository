...
# IMPORANT NOTE: This section is reliant on the cancer data if I want to make a new file
# 
...
# write_csv(health_data, "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Health_Files/ukb_health_2024.05.21")
#
# 
# # .----
...
# 
# # Load PRS files
# eur_prs = "/labs/jswitte/Projects/jjudd5/PrCa_PRScsx/Totals/eur_Score_PRS_chrAll.sscore"
# chb_prs = "/labs/jswitte/Projects/jjudd5/PrCa_PRScsx/Totals/chinese_Score_PRS_chrAll.sscore"
# afr_prs = "/labs/jswitte/Projects/jjudd5/PrCa_PRScsx/Totals/afr_Score_PRS_chrAll.sscore"
# mix_prs = "/labs/jswitte/Projects/jjudd5/PrCa_PRScsx/Totals/mixed_Score_PRS_chrAll.sscore"
# sas_prs = "/labs/jswitte/Projects/jjudd5/PrCa_PRScsx/Totals/sas_Score_PRS_chrAll.sscore"
# 
...
# 
# # Output this file
# write_csv(total_prs, "/labs/jswitte/Projects/jjudd5/PrCa_PRScsx/AllAnces_Score_PRScsx_chrAll.sscore")
# 
# 
...
#
# Load existing files: -----------------------
# I already have a lot of the files I don't want to generate them again so I'm just going to load them here
prostate_df = fread("/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Cancer_Files/ukb_cancer_2024.05.16.csv")
merged_data = fread("/labs/jswitte/Projects/jjudd5/SES.PRS_Project/SES_Files/ukb_ses_2024.05.16.csv")
total_prs =  fread("/labs/jswitte/Projects/jjudd5/PrCa_PRScsx/AllAnces_Score_PRScsx_chrAll.sscore")
health_data =  fread("/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Health_Files/ukb_health_2024.05.21")
...
write_csv(merged_df, "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Composite_DataFiles/composite_data_PRScsx_2024.05.16.csv")
