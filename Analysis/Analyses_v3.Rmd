...
saveWorkbook(wb, file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Draft_Figures/Table1_stats_2024.5.20.xlsx", overwrite = TRUE)
```
...
summ_df %>%
  write_csv( file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Draft_Figures/Figure1_models_2024.05.20.csv")
...
for (i in 1:4){
  ...
  p_mid = temp_df %>%
    ...
    annotate("text", x = 0.95, y = 10, label = "-") +
    annotate("text", x = 1.05, y = 10, label = "-") +
  ...
  # I want to make a rendition of this plot w/o the p-values
  layout <- c(
    area(t = top, l = 0, b = bottom, r = 7), 
    area(t = top, l = 5, b = bottom, r = 9)
    )
...
summ_df %>%
  ...
  write_csv( file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Supp_Figures/Supp1_models_2024.05.21.csv")
