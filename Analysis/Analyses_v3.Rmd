...
p = summ_df %>%
  ...
  scale_color_manual(
    ...
    labels = c("At least one screening", "Never screened"),
...
I'm going to split the modeling and plot generation chunk, but won't label it for the sake of the structure of this document
```{r}
...
summ_df %>%
  ...
  write_csv( file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Supp_Figures/Supp1_models_2024.04.26.csv")

```

Now generate a simple forest plot of this data
```{r}
summ_df %>% 
...
# And now export these models.
summ_df %>%
  write_csv( file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Supp_Figures/Supp2_models_2024.04.26.csv")
```
...
# And now export these models.
summ_df %>%
  write_csv( file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Supp_Figures/Supp3_Visits.nSES_models_2024.05.20.csv")
...
corr_matrix %>% 
  write_csv(., file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Supp_Figures/Supp3_corrPSA.Visits.nSES_2024.05.20.csv")

```


## Supp 4 - PSA Screening

This suppliment section is intended to build new models for the PSA Screening ~ nSES associations. This is updated from my previous version to include standardized nSES variables for all ancestries
...
# And now export these models.
summ_df %>%
  write_csv( file = "/labs/jswitte/Projects/jjudd5/SES.PRS_Project/Supp_Figures/Supp4_models_2024.04.23.csv")
